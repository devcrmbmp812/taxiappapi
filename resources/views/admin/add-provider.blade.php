    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal bordered-group" action="{{route('admin.save.provider')}}" method="POST"  role="form">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      <label class="col-sm-2 control-label">{{ tr('saldodriver') }}</label>
                      <div class="col-sm-8">
                      @if(isset($balance_driver))
                        <input type="text" name="balance_driver"  value="{{ isset($balance_driver->amount_earned) ? $balance_driver->amount_earned : old('amount_earned') }}" required class="form-control">
                        @endif
                      </div>
                    </div>
